...
public class AddClientIPAddressTask implements ConsoleTask {
    ...
    public String doTask(Map<String, String> args) {
        ...
        if ( tmpClientIP == null ) {
            ...
            ConsoleConfig.putClientIp(tmpClientIP.trim());
    ...
    public Map<String, String> argsDesc() {
        ...
        args.put(CLIENT_IP, "Need to add client IP address.");
        return args;
    }

    @Override
    public String[] getCommand() {
        return new String[] { "add_client_ip" };
    }
